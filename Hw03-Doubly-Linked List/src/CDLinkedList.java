public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
		...
		DListIterator a = ((DListIterator) s1);
		DListIterator p1 = new DListIterator(a.currentNode.previousNode);
		DListIterator b = ((DListIterator) f1);
		DListIterator n1 = new DListIterator(b.currentNode.nextNode);
		
		DListIterator c = ((DListIterator) s2);
		DListIterator p2 = new DListIterator(c.currentNode.previousNode);
		DListIterator d = ((DListIterator) f2);
		DListIterator n2 = new DListIterator(d.currentNode.nextNode);
		
		if (b.currentNode.nextNode == c.currentNode) {
			a.currentNode.previousNode = d.currentNode;
			p1.currentNode.nextNode = c.currentNode;
			b.currentNode.nextNode = n2.currentNode;
			c.currentNode.previousNode = p1.currentNode;
			d.currentNode.nextNode = a.currentNode;
			n2.currentNode.previousNode = b.currentNode;
			return ;
		}
		a.currentNode.previousNode = p2.currentNode;
		p1.currentNode.nextNode = c.currentNode;
		b.currentNode.nextNode = n2.currentNode;
		n1.currentNode.previousNode = d.currentNode;
		
		c.currentNode.previousNode = p1.currentNode;
		p2.currentNode.nextNode = a.currentNode;
		d.currentNode.nextNode = n1.currentNode;
		n2.currentNode.previousNode = b.currentNode;
	}
